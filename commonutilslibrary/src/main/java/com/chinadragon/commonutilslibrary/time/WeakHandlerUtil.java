...
public class WeakHandlerUtil {
     ...
     */
    public WeakHandlerUtil(@Nullable Handler.Callback callback) {
     ...
     */
    public WeakHandlerUtil(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public WeakHandlerUtil(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
